...
export const coreAugments: CoreAugmentDefinition[] = [
  ...
  },
  {
    ...
    name: '都江堰',
    risk: 'medium',
    description: '你的回合开始时，若能量不高于 4，额外获得 1 能量。',
    balance: '只补低能量阶段，无法突破能量上限，鼓励更频繁使用主动符文。',
    flavor: '水势分流，粮道自通。',
  },
  {
    id: 'well-field-system',
    name: '井田屯兵',
    risk: 'medium',
    description: '你的兵/卒未过河前也可以横走一步。',
    balance: '强化兵线调度，但兵/卒仍然不能后退，也不能直接获得吃子爆发。',
    flavor: '田垄成阵，步卒先整其列。',
  },
  {
    id: 'crossbow-commandery',
    name: '强弩都尉',
    risk: 'high',
    description: '你的炮可以斜走一格到空点，但不能用斜走吃子。',
    balance: '提升炮的转位能力，不改变炮隔山吃子的核心限制。',
    flavor: '弩机旁列，炮位因此多一线生门。',
  },
  {
    id: 'yumen-pass',
    name: '玉门通关',
    risk: 'medium',
    description: '你的象/相可以从两侧边路越过河界。',
    balance: '只开放边路裂隙，象眼仍会被堵，中央防线仍然有效。',
    flavor: '春风既至，边关亦开。',
  },
  {
    id: 'imperial-arsenal',
    name: '武库令',
    risk: 'low',
    description: '你的车和炮开局获得 1 层护盾。',
    balance: '保护关键远程子力一次，不提升移动范围或直接伤害。',
    flavor: '甲械入库，临阵各领一副。',
  },
  {
    id: 'nine-province-map',
    name: '禹贡九州',
    risk: 'high',
    description: '棋盘河界两端生成一对公开九州道，双方都可利用。',
    balance: '公共地形，双方共享路线；强在战略转场而非单方收益。',
    flavor: '山川入图，九州忽近。',
  },
]
